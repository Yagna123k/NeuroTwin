        ...
        <div className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          ...
          <div className="max-w-6xl mx-auto mb-16">
            ...
            >
              ...
              <div className={`relative p-10 px-20 rounded-3xl border backdrop-blur-xl transition-all duration-700 bg-gradient-to-br ${useCases[activeUseCase].bgGradient} ${useCases[activeUseCase].borderColor} shadow-2xl ${useCases[activeUseCase].glowColor}`}>
